    ...
    return (
        <>
            ...
            <motion.div
                ...
                animate="visible"
                variants={fadeIn}
                className="absolute  top-16 lg:left-10 lg:right-10 lg:top-80 backdrop-filter backdrop-blur-3xl backdrop-opacity-50 rounded-2xl lg:pt-28 lg:p-8 font-bold text-center"
            >
                {/* Company Name */}
