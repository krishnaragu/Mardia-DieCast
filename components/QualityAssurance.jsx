        ...
        >
            ...
            <div className='lg:grid lg:grid-cols-2 lg:pt-10 '>
                <Image
                    ...
                    width={347}
                    height={470}
                    className='sm:w-full ml-10 sm:ml-0 sm:h-fit lg:h-[75%]'
                />
                <p className='text-center lg:text-orange-400 bg-gradient-radial from-purple-900  rounded-xl tracking-wide md:bg-none font-extrabold text-2xl p-2 m-2 lg:text-4xl lg:pt-44 lg:p-10'>
