...
const page = () => {
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-6xl font-bold mb-4 text-center mt-3 "><span className='text-red-600'>Portable Milling Machine</span> (PMM)</h1>
            ...
            <div className='pt-5'>
                <figure className='grid grid-cols-3 gap-10 justify-between'>
                    <p className='text-2xl p-3 align-middle text-center mt-auto mb-auto'>Dent/Depression<br /> Marks on Platen</p>
